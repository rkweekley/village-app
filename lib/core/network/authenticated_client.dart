...
/// Tracks whether the auth interceptor has been attached to the shared
/// [dioProvider] instance.  Set to true on first provider build so that
/// subsequent rebuilds don't stack duplicate interceptors.
